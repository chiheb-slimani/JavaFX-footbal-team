...
public class AfficherStatMC {

    @FXML private TableView<StatistiqueMatch> tableView;
    ...
    @FXML private TableColumn<StatistiqueAttaquant, Integer> passecles;
    @FXML private TableColumn<StatistiqueAttaquant, Integer>  recuperationDeBalles;

    private ObservableList<StatistiqueMatch> stats = FXCollections.observableArrayList();
    ...
    public void initialize() {
        ...
        passecles.setCellValueFactory(new PropertyValueFactory<>("passecles"));
       recuperationDeBalles.setCellValueFactory(new PropertyValueFactory<>("recuperationDeBalles"));
