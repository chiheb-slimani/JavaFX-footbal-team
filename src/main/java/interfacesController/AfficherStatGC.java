...
public class AfficherStatGC {
    ...
    @FXML private TableColumn<StatistiqueAttaquant, Integer> cleanSheetColumn;
    @FXML private TableColumn<StatistiqueAttaquant, Integer>  ParadesColumn;
    ...
    public void initialize() {
        ...
        ParadesColumn.setCellValueFactory(new PropertyValueFactory<>("parades"));
